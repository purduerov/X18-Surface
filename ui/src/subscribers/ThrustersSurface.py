...
class ThrustersSurfaceNode(Node):
    ...
    def thrust_callback(self, comm):
        self.window.ui.bfloutput.setProperty("value", int(comm.thrusters[5]))
        self.window.ui.bfroutput.setProperty("value", int(comm.thrusters[8]))
        self.window.ui.bbloutput.setProperty("value", int(comm.thrusters[6]))
        self.window.ui.bbroutput.setProperty("value", int(comm.thrusters[7]))
        self.window.ui.tfloutput.setProperty("value", int(comm.thrusters[1]))
        self.window.ui.tfroutput.setProperty("value", int(comm.thrusters[4]))
        self.window.ui.tbloutput.setProperty("value", int(comm.thrusters[2]))
        self.window.ui.tbroutput.setProperty("value", int(comm.thrusters[3]))

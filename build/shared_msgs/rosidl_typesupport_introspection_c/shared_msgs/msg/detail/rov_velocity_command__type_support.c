...
static rosidl_typesupport_introspection_c__MessageMember shared_msgs__msg__RovVelocityCommand__rosidl_typesupport_introspection_c__RovVelocityCommand_message_member_array[5] = {
  {
    "twist",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shared_msgs__msg__RovVelocityCommand, pitch_lock),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shared_msgs__msg__RovVelocityCommand, depth_lock),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer

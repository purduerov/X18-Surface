...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RovVelocityCommand_message_member_array[6] = {
  {
    "twist",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shared_msgs::msg::RovVelocityCommand, source),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shared_msgs::msg::RovVelocityCommand, multiplier),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shared_msgs::msg::RovVelocityCommand, is_percent_power),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer

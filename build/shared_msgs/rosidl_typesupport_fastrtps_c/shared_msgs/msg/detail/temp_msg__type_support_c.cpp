...
#include "shared_msgs/msg/detail/temp_msg__rosidl_typesupport_fastrtps_c.h"
...
using _TempMsg__ros_msg_type = shared_msgs__msg__TempMsg;
...
size_t get_serialized_size_shared_msgs__msg__TempMsg(
  const void * untyped_ros_message,
...
static uint32_t _TempMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_shared_msgs__msg__TempMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shared_msgs
size_t max_serialized_size_shared_msgs__msg__TempMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = shared_msgs__msg__TempMsg;
    is_plain =
      (
...
static size_t _TempMsg__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_shared_msgs__msg__TempMsg(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, shared_msgs, msg, TempMsg)() {

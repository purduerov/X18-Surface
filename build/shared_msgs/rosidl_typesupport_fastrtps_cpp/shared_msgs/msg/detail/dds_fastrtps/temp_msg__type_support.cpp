...
#include "shared_msgs/msg/detail/temp_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const shared_msgs::msg::TempMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  shared_msgs::msg::TempMsg & ros_message)
{
  // Member: temperature
  cdr >> ros_message.temperature;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = shared_msgs::msg::TempMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const shared_msgs::msg::TempMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<shared_msgs::msg::TempMsg *>(
    untyped_ros_message);
...
static size_t _TempMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TempMsg(full_bounded, is_plain, 0);
...
{
  return &shared_msgs::msg::typesupport_fastrtps_cpp::_TempMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, shared_msgs, msg, TempMsg)() {
  return &shared_msgs::msg::typesupport_fastrtps_cpp::_TempMsg__handle;
}

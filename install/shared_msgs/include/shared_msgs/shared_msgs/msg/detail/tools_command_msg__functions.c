...
shared_msgs__msg__ToolsCommandMsg__are_equal(const shared_msgs__msg__ToolsCommandMsg * lhs, const shared_msgs__msg__ToolsCommandMsg * rhs)
{
  ...
  // motor_tools
  if (lhs->motor_tools != rhs->motor_tools) {
    return false;
  }
  return true;
}
  ...
  shared_msgs__msg__ToolsCommandMsg * output)
{
  ...
  // tools
  for (size_t i = 0; i < 5; ++i) {
    output->tools[i] = input->tools[i];
  }
  // motor_tools
  output->motor_tools = input->motor_tools;
  return true;
}
...
shared_msgs__msg__ToolsCommandMsg__create()
{
  ...
  shared_msgs__msg__ToolsCommandMsg * msg = (shared_msgs__msg__ToolsCommandMsg *)allocator.allocate(sizeof(shared_msgs__msg__ToolsCommandMsg), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(shared_msgs__msg__ToolsCommandMsg));
  bool success = shared_msgs__msg__ToolsCommandMsg__init(msg);
  if (!success) {
...
shared_msgs__msg__ToolsCommandMsg__destroy(shared_msgs__msg__ToolsCommandMsg * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    shared_msgs__msg__ToolsCommandMsg__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
shared_msgs__msg__ToolsCommandMsg__Sequence__init(shared_msgs__msg__ToolsCommandMsg__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shared_msgs__msg__ToolsCommandMsg * data = NULL;

  if (size) {
    data = (shared_msgs__msg__ToolsCommandMsg *)allocator.zero_allocate(size, sizeof(shared_msgs__msg__ToolsCommandMsg), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = shared_msgs__msg__ToolsCommandMsg__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        shared_msgs__msg__ToolsCommandMsg__fini(&data[i - 1]);
      }
...
shared_msgs__msg__ToolsCommandMsg__Sequence__fini(shared_msgs__msg__ToolsCommandMsg__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      shared_msgs__msg__ToolsCommandMsg__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shared_msgs__msg__ToolsCommandMsg__Sequence * array = (shared_msgs__msg__ToolsCommandMsg__Sequence *)allocator.allocate(sizeof(shared_msgs__msg__ToolsCommandMsg__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = shared_msgs__msg__ToolsCommandMsg__Sequence__init(array, size);
  if (!success) {
...
shared_msgs__msg__ToolsCommandMsg__Sequence__destroy(shared_msgs__msg__ToolsCommandMsg__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    shared_msgs__msg__ToolsCommandMsg__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
shared_msgs__msg__ToolsCommandMsg__Sequence__are_equal(const shared_msgs__msg__ToolsCommandMsg__Sequence * lhs, const shared_msgs__msg__ToolsCommandMsg__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!shared_msgs__msg__ToolsCommandMsg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  shared_msgs__msg__ToolsCommandMsg__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(shared_msgs__msg__ToolsCommandMsg);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    shared_msgs__msg__ToolsCommandMsg * data =
      (shared_msgs__msg__ToolsCommandMsg *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!shared_msgs__msg__ToolsCommandMsg__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          shared_msgs__msg__ToolsCommandMsg__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!shared_msgs__msg__ToolsCommandMsg__copy(

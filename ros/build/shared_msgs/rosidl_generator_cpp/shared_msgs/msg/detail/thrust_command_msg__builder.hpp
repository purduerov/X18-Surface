...
class Init_ThrustCommandMsg_multiplier
{
public:
  explicit Init_ThrustCommandMsg_multiplier(::shared_msgs::msg::ThrustCommandMsg & msg)
  : msg_(msg)
  {}
  ::shared_msgs::msg::ThrustCommandMsg multiplier(::shared_msgs::msg::ThrustCommandMsg::_multiplier_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_ThrustCommandMsg_multiplier is_fine(::shared_msgs::msg::ThrustCommandMsg::_is_fine_type arg)
  {
    msg_.is_fine = std::move(arg);
    return Init_ThrustCommandMsg_multiplier(msg_);
  }

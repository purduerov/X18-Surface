...
bool shared_msgs__msg__imu_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("shared_msgs.msg._imu_msg.ImuMsg", full_classname_dest, 31) == 0);
  }
  shared_msgs__msg__ImuMsg * ros_message = _ros_message;
  {  // header
...
PyObject * shared_msgs__msg__imu_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("shared_msgs.msg._imu_msg");
